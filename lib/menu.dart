...
class MyHomePage extends StatelessWidget {
    ...
    final String view = 'You have pressed the View Product List button'; // NPM
    final String add = 'You have pressed the Add Product button'; // Name
    final String logout = 'You have pressed the Logout button'; // Class
    final List<ItemHomepage> items = [
    ItemHomepage("View Product List", Icons.visibility),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                InfoCard(title: 'View', content: view),
                InfoCard(title: 'Add', content: add),
                InfoCard(title: 'Logout', content: logout),
              ],
            ),
